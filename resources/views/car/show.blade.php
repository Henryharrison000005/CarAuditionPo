 <x-app-layout bodyClass="page-my-cars">
        <main>
      <div class="container">
        <h1 class="car-details-page-title">{{$car->baseModels->name}}</h1>
        <div class="car-details-region">>{{$car->city->name}} {{ $car->year }} - {{ $car->maker->name }} {{$car->baseModels->name}}</div>
